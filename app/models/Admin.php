...
class Admin
{
	...
	// Vamos a verificar que los datos del usuarios que recibimos son los mismos que tenemos en la base de datos.
	public function verifyUser($data)
	{
		...
		if (empty($admins)) {
			...
			array_push($errors, 'El usuario esta dado de baja');
		} else  {
